...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Self-hosted, OpenAI-compatible discriminative inference — embeddings, '
            ."reranking, classification, vision and speech.\n\n"
            .'**Auth:** send `Authorization: Bearer <token>`. Create tokens in the dashboard. '
            .'OpenAI SDKs work against `base_url = https://crunch.stumason.dev`.',
    ],
